...
/** gentChartByAi POST /api/chart/gen */
export async function gentChartByAiUsingPOST(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.gentChartByAiUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
...
/** gentChartByAiAsync POST /api/chart/gen/async */
export async function gentChartByAiAsyncUsingPOST(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.gentChartByAiAsyncUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
...
/** gentChartByAiAsyncMq POST /api/chart/gen/async/mq */
export async function gentChartByAiAsyncMqUsingPOST(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.gentChartByAiAsyncMqUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
...
/** regenChartByAi POST /api/chart/regen */
export async function regenChartByAiUsingPOST(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.regenChartByAiUsingPOSTParams,
  options?: { [key: string]: any },
) {
